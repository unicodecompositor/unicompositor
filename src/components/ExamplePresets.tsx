...
(10×6):H0-55;"2"44-55;O4-59`,
  ...
  {
    name: 'Nested #ID',
    code: `# Define a reusable block with id
(5)[id="vec_F"]:F5-24;→[c=blue]0-9

# Use it in a new scene by #id reference
(10×6)[id="vec_AF"]:#vec_F[f=h]0-29;A0-57

# Use it in a new scene by #id reference
(10×6):#vec_AF[f=h]0-29`,
    description: 'Embed composed blocks by #id',
  },
  {
    name: 'Chinese: 森',
    code: `# "Tree" (木) = horizontal + vertical + left & right strokes
(12)[id="tree"]:一0-107;丨1-142;㇏3-143;㇏[f=h]0-140

# "Forest" (林) = two trees
(12×7)[id="park"]:#tree[c="#000"]0-78;#tree[c="#000"]5-83

# "Dense forest" (森) = three trees,
(15)[id="forest"]:#tree[c="#000"]0-134;#park[c="#000"]90-224`,
    description: 'Compose 森 from strokes & radicals',
  },
];
