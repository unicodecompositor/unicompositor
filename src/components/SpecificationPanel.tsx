...
import { UniCompSpec, SymbolSpec, linearToCoords, getRect, stringifySpec, resizeGrid, getRegistry } from '@/lib/unicomp-parser';
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {(symbol.refId || symbol.refName || symbol.refClass) ? (
                      <span
